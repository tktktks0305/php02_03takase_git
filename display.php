...
$stmt = $pdo->prepare("SELECT * FROM mil_proto1_itemTable");
...
if($status==false) {
  ...
  while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){ 
    ...
    $view .=      '<li class = "list-group-item">サイズ：'.h($result['size']).'</li>';
    ...
    $view .=      '<a class = "btn btn-primary me-2" href="u_view.php?id='.h($result['id']).'">更新</a>';
...
<div class="container container-m">
  <legend class="mb-3">登録アイテム一覧</legend>
